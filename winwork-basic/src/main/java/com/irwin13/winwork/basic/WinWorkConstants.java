...
/**
 * @author irwin Timestamp : 17/04/2014 19:44
 */
public final class WinWorkConstants {
    ...
    public static final String ORACLE_DATE_FORMAT_DATE_TIME = "dd-mm-yyyy hh24:mi:ss";
    ...
    public static final String NODE_NAME_MISSING = "missing '-D" + WINWORK_NODE_NAME + "' argument";
